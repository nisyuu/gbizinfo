...
module Gbizinfo
  class CertificationInfo
    ...
    # 企業規模
    attr_accessor :enterprise_scale
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Gbizinfo::CertificationInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Gbizinfo::CertificationInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'enterprise_scale')
        self.enterprise_scale = attributes[:'enterprise_scale']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enterprise_scale == o.enterprise_scale &&
    ...
    def hash
      [category, date_of_approval, enterprise_scale, expiration_date, government_departments, target, title].hash
    end
