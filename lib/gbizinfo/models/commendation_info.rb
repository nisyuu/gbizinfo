...
module Gbizinfo
  class CommendationInfo
    ...
    # 年月日
    attr_accessor :date_of_commendation
    ...
    def self.attribute_map
      {
        :'category' => :'category',
        :'date_of_commendation' => :'date_of_commendation',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Gbizinfo::CommendationInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Gbizinfo::CommendationInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'date_of_commendation')
        self.date_of_commendation = attributes[:'date_of_commendation']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          category == o.category &&
          date_of_commendation == o.date_of_commendation &&
    ...
    def hash
      [category, date_of_commendation, government_departments, target, title].hash
    end
